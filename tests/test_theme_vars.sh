...
TOCP="$(build_site_with tocfont=Lora)/docs/quickstart/index.html"
assert_grep "$TOCP" "--toc-font:Lora" "configured TOC font injected into :root"
...
assert_contains "$P" "--post-title-font:Lora, Georgia, serif" "configured blog post title font injected into :root"
